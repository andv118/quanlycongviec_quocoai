...
<head>
  ...
  <title>Đăng nhập | Quốc Oai</title>
...
<div class="login-box">
  ...
  <div class="card" >
    <div class="card-body login-card-body" style="border-radius: 10px;box-shadow: -1px 4px 5px 8px;">
      <p class="login-box-msg"><b>Hệ thống điều hành nội bộ Quốc Oai</b></p>
      <div style="display: flex;align-items: center;justify-content: center;">
      	<img src="public/images/logo.png" style="width: 30%;height: auto;border-radius: 50%;margin-bottom: 20px;">
      </div>
